...
def train_gru_fmtl(num_nodes, train_loader, test_loader, adjacency_matrix, lambda_reg=0.1, epochs=10, device="cpu", node_fraction=0.5):
    """Federated Multi-Task Learning with Regularization."""
    ...
    for epoch in range(epochs):
        ...
        for node in participating_nodes:
            ...
            for X_batch, Y_batch in train_loader:
                ...
                loss += lambda_reg * model.regularization_loss(model.fc.weight)
                loss.backward()
                optimizer.step()
